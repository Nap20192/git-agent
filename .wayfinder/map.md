...
- [Граф Рана в Playground](tickets/012-run-graph.md) — панель-звезда Лид→Сабагенты в Playground, охват — один ход с переключением по ленте Событий, live через SSE activity (закрывает пункт 1 PLAYGROUND-TODO), персист активности в hub-таблицу; дэшборд-сводка — приоритет 2. В работе: агент graph (wt/graph).
